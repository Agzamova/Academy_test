...
/* harmony import */ var _components_more__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/more */ "./src/js/components/more.js");
/* harmony import */ var _components_more__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_more__WEBPACK_IMPORTED_MODULE_2__);
...
/***/ "./src/js/components/more.js":
/*!***********************************!*\
  !*** ./src/js/components/more.js ***!
  \***********************************/
/***/ (() => {

let points = document.querySelectorAll('.card__btn');
for (let el of points) {
  el.addEventListener('click', () => {
    el.previousElementSibling.classList.remove('points');
  });
}
...
const slider = document.querySelector('.swiper__main');
const sliderNav = document.querySelector('.swiper__nav');
const slider2 = document.querySelector('.swiper2');
let mySwiperNav = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](sliderNav, {
  slidesPerView: 4,
  spaceBetween: 8,
  loopedSlides: 5,
  freeMode: true,
...
let mySwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](slider, {
  slidesPerView: 1,
  spaceBetween: 8,
  mousewheel: true,
  loop: true,
...
let sliderRec = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](slider2, {
  slidesPerView: 1,
  spaceBetween: 32,
  loopedSlides: 5,
  freeMode: true,
...
let el = document.querySelector('.tooltip__btn');
let tooltip = document.querySelector('.tooltip__txt');
...
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.footer__form', rules, afterForm);
